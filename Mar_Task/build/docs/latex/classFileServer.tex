\hypertarget{classFileServer}{}\doxysection{File\+Server Class Reference}
...
Collaboration diagram for File\+Server\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
static void \mbox{\hyperlink{classFileServer_a926f7f6a93cded39b78759ae329561d0}{process\+\_\+data}} (std\+::vector$<$ double $>$ \&data)
\begin{DoxyCompactList}\small\item\em Производит вычисления и находит контур объединения прямоугольников, переданных от клиента \end{DoxyCompactList}\item 
...
\item Обработку данных через \mbox{\hyperlink{classFileServer_a926f7f6a93cded39b78759ae329561d0}{process\+\_\+data()}}
...
\mbox{\Hypertarget{classFileServer_a926f7f6a93cded39b78759ae329561d0}\label{classFileServer_a926f7f6a93cded39b78759ae329561d0}} 
...
{\footnotesize\ttfamily static void File\+Server\+::process\+\_\+data (\begin{DoxyParamCaption}\item[{std\+::vector$<$ double $>$ \&}]{data }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}, {\ttfamily [private]}}



Производит вычисления и находит контур объединения прямоугольников, переданных от клиента 

Выполняется следующее\+:
\begin{DoxyEnumerate}
\item Передается вектор значений
\item Вектор обрабатывается и определяются вершины прямоугольника
\item Создается и заполняется массив прямоугольников
\item Выполняется основноц алгоритм нахождения контура объединения прямоугольников
\item Контур записывается в список в виде ребер
\item Возвращается изменный вектор
\end{DoxyEnumerate}


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em data} & Вектор из чисел, которые являются координатами точек вершин прямоугольника. \\
\hline
\end{DoxyParams}
